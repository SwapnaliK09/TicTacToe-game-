...
public class MainActivity extends AppCompatActivity {
    ...
    private void changePlayerTurn(int currentPlayerTurn) {
        ...
        if (playerTurn==1){
            playerOneLayout.setBackgroundResource(R.drawable.rounded_back_blue_border);
            playerTwoLayout.setBackgroundResource(R.drawable.round_back_dark_blue);
        }
        else {
            playerTwoLayout.setBackgroundResource(R.drawable.rounded_back_blue_border);
    ...
    public void restartMatch() {
        ...
        image1.setImageResource(R.drawable.background_icon);
        image2.setImageResource(R.drawable.background_icon);
        image3.setImageResource(R.drawable.background_icon);
        image4.setImageResource(R.drawable.background_icon);
        image5.setImageResource(R.drawable.background_icon);
        image6.setImageResource(R.drawable.background_icon);
        image7.setImageResource(R.drawable.background_icon);
        image8.setImageResource(R.drawable.background_icon);
        image9.setImageResource(R.drawable.background_icon);
    }
}